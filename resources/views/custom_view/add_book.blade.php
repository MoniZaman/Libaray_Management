                ...
                <div class="panel-body">           		 
					<form method="post" class="form-horizontal" role="form"  action="{{URL::to('/home/booklist/store')}}" enctype="multipart/form-data">
						<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
								<input type="text" class="form-control" name="book_name" value="" placeholder="book name">
						...
						<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
						        <input type="text" class="form-control" name="another_author_name" value="" placeholder="book name">
						    </div>	
						</div>    		   
						<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">ISBN</label>
                            <div class="col-md-6">
								<input type="text" class="form-control" name="isbn_number" value="" placeholder="ISBN number">
							</div>
						</div>
						<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
